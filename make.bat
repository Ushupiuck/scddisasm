...
..\bin\GetPsyQSyms.exe "DA Garden\Track Titles.sym" "DA Garden\Track Title Labels.i"
...
..\bin\GetPsyQSyms.exe "Special Stage\Stage Data.sym" "Special Stage\Stage Data Labels.i"
