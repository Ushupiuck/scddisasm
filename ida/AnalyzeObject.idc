...
static InitObjectDefine(void)
{
	...
	MakeName(CheckObjDespawn2, "CheckObjDespawn2");
...
static AnalyzeSonic(void)
{
	...
	StartFuncFromOp(ObjSonic_Main, "ObjSonic_ExtCamera", 0);
	StartFuncFromOp(ObjSonic_Main + 2, "ObjSonic_MakeWaterfallSplash", 0);
	
	if (zone != 4) {
		ObjSonic_TimeWarp = StartFuncFromOp(ObjSonic_Main + 0x4A, "ObjSonic_TimeWarp", 0);
		ObjSonic_ModeIndex = NameFromOp(ObjSonic_Main + 0x5A, "ObjSonic_ModeIndex", 0);
		SpecialCollision = StartFuncFromOp(ObjSonic_Main + 0x62, "SpecialCollision", 0);
		StartFuncFromOp(ObjSonic_Main + 0x68, "ObjSonic_Display", 0);
		StartFuncFromOp(ObjSonic_Main + 0x6A, "ObjSonic_RecordPos", 0);
		StartFuncFromOp(ObjSonic_Main + 0x6E, "ObjSonic_Water", 0);
		ObjSonic_Animate = StartFuncFromOp(ObjSonic_Main + 0x90, "ObjSonic_Animate", 0);
		ObjectCollision = StartFuncFromOp(ObjSonic_Main + 0xA2, "ObjectCollision", 0);
		StartFuncFromOp(ObjSonic_Main + 0xA8, "ObjSonic_CheckChunk", 0);
	} else {
		ObjSonic_TimeWarp = StartFuncFromOp(ObjSonic_Main + 0x34, "ObjSonic_TimeWarp", 0);
		ObjSonic_ModeIndex = NameFromOp(ObjSonic_Main + 0x44, "ObjSonic_ModeIndex", 0);
		StartFuncFromOp(ObjSonic_Main + 0x4C, "ObjSonic_CheckBouncyFloor", 0);
		StartFuncFromOp(ObjSonic_Main + 0x50, "ObjSonic_CheckSparks", 0);
		StartFuncFromOp(ObjSonic_Main + 0x54, "ObjSonic_CheckElecBeam", 0);
		StartFuncFromOp(ObjSonic_Main + 0x58, "ObjSonic_CheckHangBar", 0);
		StartFuncFromOp(ObjSonic_Main + 0x5C, "ObjSonic_CheckRotPole", 0);
		
		StartFuncFromOp(ObjSonic_Main + 0x60, "ObjSonic_Display", 0);
		StartFuncFromOp(ObjSonic_Main + 0x62, "ObjSonic_RecordPos", 0);
		ObjSonic_Animate = StartFuncFromOp(ObjSonic_Main + 0x72, "ObjSonic_Animate", 0);
		ObjectCollision = StartFuncFromOp(ObjSonic_Main + 0x84, "ObjectCollision", 0);
		StartFuncFromOp(ObjSonic_Main + 0x8A, "ObjSonic_CheckChunk", 0);
	}
	...
	if (zone != 4) {
		StartFuncFromOp(ObjSonic_MdGround, "ObjSonic_ChkBoredom", 0);
		StartFuncFromOp(ObjSonic_MdGround + 0x26, "ObjSonic_StageBound", 0);
		StartFuncFromOp(ObjSonic_MdGround + 0x30, "ObjSonic_Handle3DRamp", 0);
		ObjSonic_CheckJump = StartFuncFromOp(ObjSonic_MdGround + 0x38, "ObjSonic_CheckJump", 0);
		StartFuncFromOp(ObjSonic_MdGround + 0x3C, "ObjSonic_SlopeResist", 0);
		ObjSonic_MoveGround = StartFuncFromOp(ObjSonic_MdGround + 0x40, "ObjSonic_MoveGround", 0);
		StartFuncFromOp(ObjSonic_MdGround + 0x44, "ObjSonic_CheckRoll", 0);
		StartFuncFromOp(ObjSonic_MdGround + 0x56, "ObjSonic_CheckFall", 0);
		
		StartFuncFromOp(ObjSonic_MdAir + 0x22, "ObjSonic_JumpHeight", 0);
		StartFuncFromOp(ObjSonic_MdAir + 0x26, "ObjSonic_MoveAir", 0);
		StartFuncFromOp(ObjSonic_MdAir + 0x42, "ObjSonic_JumpAngle", 0);
		...
		StartFuncFromOp(ObjSonic_TimeWarp + 0xC2, "ObjSonic_MakeTimeWarpStars", 0);
		
		StartFuncFromOp(ObjSonic_MoveGround + 0x2B8, "ObjSonic_StartRoll", 0);
		StartFunction(ObjSonic_MoveGround + 0x348, "ObjSonic_CheckWallCol");
	} else {
		StartFuncFromOp(ObjSonic_MdGround + 0x12, "ObjSonic_ChkBoredom", 0);
		StartFuncFromOp(ObjSonic_MdGround + 0x38, "ObjSonic_StageBound", 0);
		StartFuncFromOp(ObjSonic_MdGround + 0x42, "ObjSonic_Handle3DRamp", 0);
		ObjSonic_CheckJump = StartFuncFromOp(ObjSonic_MdGround + 0x4A, "ObjSonic_CheckJump", 0);
		StartFuncFromOp(ObjSonic_MdGround + 0x4E, "ObjSonic_SlopeResist", 0);
		ObjSonic_MoveGround = StartFuncFromOp(ObjSonic_MdGround + 0x52, "ObjSonic_MoveGround", 0);
		StartFuncFromOp(ObjSonic_MdGround + 0x56, "ObjSonic_CheckRoll", 0);
		StartFuncFromOp(ObjSonic_MdGround + 0x68, "ObjSonic_CheckFall", 0);
		
		StartFuncFromOp(ObjSonic_MdAir + 0x1C, "ObjSonic_HangBar", 0);
		StartFuncFromOp(ObjSonic_MdAir + 0x2A, "ObjSonic_JumpHeight", 0);
		StartFuncFromOp(ObjSonic_MdAir + 0x2E, "ObjSonic_MoveAir", 0);
		StartFuncFromOp(ObjSonic_MdAir + 0x4A, "ObjSonic_JumpAngle", 0);
		PlayerAirCollision = StartFuncFromOp(ObjSonic_MdAir + 0x4E, "PlayerAirCollision", 0);
		
		StartFuncFromOp(ObjSonic_MdJump + 8, "ObjSonic_RotPole", 0);
	
		StartFuncFromOp(ObjSonic_TimeWarp + 0x86, "SaveTimeWarpData", 0);
		StartFuncFromOp(ObjSonic_TimeWarp + 0x98, "ObjSonic_MakeTimeWarpStars", 0);
		
		StartFuncFromOp(ObjSonic_MoveGround + 0x2A0, "ObjSonic_StartRoll", 0);
		StartFunction(ObjSonic_MoveGround + 0x348, "ObjSonic_CheckWallCol");
	}
	
	StartFuncFromOp(ObjSonic_MdRoll + 0xC, "ObjSonic_SlopeResistRoll", 0);
	ObjSonic_MoveRoll = StartFuncFromOp(ObjSonic_MdRoll + 0x10, "ObjSonic_MoveRoll", 0);
	
	StartFuncFromOp(ObjSonic_MoveGround + 0x24, "ObjSonic_MoveGndLeft", 0);
	StartFuncFromOp(ObjSonic_MoveGround + 0x30, "ObjSonic_MoveGndRight", 0);
	
	StartFuncFromOp(ObjSonic_MoveRoll + 0x28, "ObjSonic_MoveRollLeft", 0);
	StartFuncFromOp(ObjSonic_MoveRoll + 0x34, "ObjSonic_MoveRollRight", 0);
	
	StartFuncFromOp(ObjSonic_CheckJump + 0x2E, "ObjSonic_ChkFlipper", 0);
	StartFuncFromOp(PlayerAirCollision + 0x64, "PlayerChkBlockDownWide", 0);
	StartFuncFromOp(PlayerAirCollision + 0xFE, "PlayerChkBlockUpWide", 0);
	StartFuncFromOp(PlayerAirCollision + 0x18E, "GroundPlayerSteep", 0);
	StartFuncFromOp(PlayerChkBlockAbove + 0x14, "PlayerChkBlockLeftWide", 0);
	StartFuncFromOp(PlayerChkBlockAbove + 0x24, "PlayerChkBlockRightWide", 0);
...
{
	// Sonic
	Rename("ObjSonic_0_Routine0", "ObjSonic_Init");
	Rename("ObjSonic_0_Routine2", "ObjSonic_Main");
	Rename("ObjSonic_0_Routine4", "ObjSonic_Hurt");
	Rename("ObjSonic_0_Routine6", "ObjSonic_Dead");
	Rename("ObjSonic_0_Routine8", "ObjSonic_Restart");
	Rename("ObjSonic_1_Routine0", "ObjSonic_MdGround");
	Rename("ObjSonic_1_Routine2", "ObjSonic_MdAir");
	Rename("ObjSonic_1_Routine4", "ObjSonic_MdRoll");
	Rename("ObjSonic_1_Routine6", "ObjSonic_MdJump");
	AnalyzeSonic();
	...
	Rename("ObjSpring_1_Routine14", "ObjSpring_DiagMain");
	Rename("ObjSpring_1_Routine16", "ObjSpring_DiagAnim");
	Rename("ObjSpring_1_Routine18", "ObjSpring_DiagReset");
	if (ObjSpring > 0) {
	...
	Rename("ObjTitleCard_0_Routine2", "ObjTitleCard_SlideInVert");
	Rename("ObjTitleCard_0_Routine4", "ObjTitleCard_SlideInHoriz");
	Rename("ObjTitleCard_0_Routine6", "ObjTitleCard_SlideOutVert");
	Rename("ObjTitleCard_0_Routine8", "ObjTitleCard_SlideOutHoriz");
